		...
		<?php
			...
			if(isset($_GET["id"])){
			   if(is_numeric($_GET["id"])){
					$id = $_GET["id"];
					$sql = "select * from pecas where id_pecas = ".$_GET["id"];
...
<div class="container">
	<p>
		<h3 align="center">Editar Peças</h3>
		<hr>
	<p>
	<div class="row justify-content-sm-center">
	   <div class="col-md-10 col-sm-4">
	       <form name="" method="POST" action="alterarpecas.php">
							<div class="form-row mt-2 mb-3">
										<div class="col-md-6">
											<input type="hidden" class="form-control" name="campoID" value="<?php echo $resultado["id_pecas"];?>"/>
										</div>
									</div>
							<div class="form-row mt-2 mb-3">
						    <div class="col-md-6">
								<label for="nome">Nome:</label>
								<input type="text" class="form-control" name="nome" placeholder="Nome" value="<?php echo $resultado["nomepeca"];?>" required/>
							</div>
							<div class="col-md-6">
								<label for="codigo">Código:</label>
								<input type="text" class="form-control" name="codigo" placeholder="Código" value="<?php echo $resultado["codigopeca"];?>" disabled/>
							</div>
						</div>
						<div class="form-row mt-2 mb-3">
						    <div class="col-md-12">
								<label>Descrição: (Opcional)</label>
								<textarea class="form-control" name="descricao" placeholder="Explique a peça, se possui algum defeito ou uma observação útil" required/><?php echo $resultado['descricaopeca'] ?></textarea>
							</div>
						</div>
						<div class="form-row mt-2 mb-3">					
							<div class="col-md-12">
						...
						<div class="form-row mt-2">
							<div class="col-md-8">
								<label for="nomeutilizador">Nome Utilizador:</label>
