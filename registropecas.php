<html>	
	...
	?>
		<title>Registrar Peças - pSGO</title>
...
<div class="container">
	<p>
		<h3 align="center">Registrar Peças</h3>
		<hr>
	<p>
	<div class="row justify-content-sm-center">
	   <div class="col-md-10 col-sm-4">
	       <form name="" method="POST" action="inclusaopecas.php">
						...
						<div class="form-row mt-2 mb-3">
						    <div class="col-md-12">
								...
								<textarea class="form-control" name="descricao" placeholder="Explique a peça, se possui algum defeito ou uma observação útil"/></textarea>
							</div>
						</div>
						<div class="form-row mt-2 mb-3">					
							<div class="col-md-12">
						...
						<!--<div class="form-row mt-2 mb-3">
							...
							<div class="col-md-4">
								<div class="form-group">
									...
									<select class="form-control" name="uso" required>
